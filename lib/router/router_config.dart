...
final GoRouter router = GoRouter(
  ...
  builder: (BuildContext context, GoRouterState state) {
    final String path = state.uri.toString(); // Récupérez l'URL complète
    final Uri uri = Uri.parse(path); // Convertissez l'URL en objet Uri
    final String searchQuery = uri.queryParameters['query'] ?? ''; // Accédez aux paramètres de la requête
